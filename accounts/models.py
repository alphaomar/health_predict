...
class Prescription(models.Model):
    ...
    medication = models.ForeignKey(Medication, on_delete=models.CASCADE, related_name='prescriptions', blank=True, null=True)
...
class Appointment(models.Model):
    ...
    def __str__(self):
        return f"Appointment with {self.doctor.user.email} for {self.patient.user.email} on {self.appointment_date}"
