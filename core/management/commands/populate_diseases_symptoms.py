...
class Command(BaseCommand):
    help = 'Populate diseases and symptoms'
    ...
    def handle(self, *args, **kwargs):
        ...
        for disease in diseaselist:
            Disease.objects.get_or_create(name=disease)

        for symptom in symptomslist:
            Symptom.objects.get_or_create(name=symptom)

        self.stdout.write(self.style.SUCCESS('Successfully populated diseases and symptoms'))
